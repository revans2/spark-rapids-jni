...
public class GetJsonObjectTest {
  ...
  void validJsonTestID7() {
    ...
    try (ColumnVector cv = ColumnVector.fromStrings(
         ...
         ColumnVector expected = ColumnVector.fromBooleans(false, true, true, false, false, true, false, false);
         ColumnVector found = JSONUtils.isJsonValid(cv, 7)) {
      assertColumnsAreEqual(expected, found);
    }
  }

  @Test
  void validJsonTestID8() {
    StringBuilder padding = new StringBuilder();
    for (int i = 0; i < 128; i++) {
      //padding.append(i%10);
      padding.append(' ');
    ...
    try (ColumnVector cv = ColumnVector.fromStrings(
         ...
         ColumnVector expected = ColumnVector.fromBooleans(false, true, true, false, false, true, false, false);
         ColumnVector found = JSONUtils.isJsonValid(cv, 8)) {
      assertColumnsAreEqual(expected, found);
    }
  }

  @Test
  void validJsonTestID9() {
    StringBuilder padding = new StringBuilder();
    for (int i = 0; i < 128; i++) {
      //padding.append(i%10);
      padding.append(' ');
    ...
    try (ColumnVector cv = ColumnVector.fromStrings(
         ...
         ColumnVector expected = ColumnVector.fromBooleans(false, true, true, false, false, true, false, false);
         ColumnVector found = JSONUtils.isJsonValid(cv, 9)) {
      assertColumnsAreEqual(expected, found);
    }
  }

  @Test
  void validJsonTestID10() {
    StringBuilder padding = new StringBuilder();
    for (int i = 0; i < 128; i++) {
      //padding.append(i%10);
      padding.append(' ');
    ...
    try (ColumnVector cv = ColumnVector.fromStrings(
         ...
         ColumnVector expected = ColumnVector.fromBooleans(false, true, true, false, false, true, false, false);
         ColumnVector found = JSONUtils.isJsonValid(cv, 10)) {
      assertColumnsAreEqual(expected, found);
    }
  }
